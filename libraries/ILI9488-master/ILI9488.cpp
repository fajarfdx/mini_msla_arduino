...
ILI9488::ILI9488(int8_t cs, int8_t dc, int8_t mosi,
				   int8_t sclk, int8_t rst, int8_t miso) : Adafruit_GFX_AS(ILI9488_TFTWIDTH, ILI9488_TFTHEIGHT) {
  _cs   = cs;
  _dc   = dc;
  _mosi  = mosi;
  _miso = miso;
...
ILI9488::ILI9488(int8_t cs, int8_t dc, int8_t rst) : Adafruit_GFX_AS(ILI9488_TFTWIDTH, ILI9488_TFTHEIGHT) {
  _cs   = cs;
  _dc   = dc;
  _rst  = rst;
  hwSPI = true;
...
void ILI9488::pushColors(uint16_t *data, uint8_t len) {
  uint16_t color;
